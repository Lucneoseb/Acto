...
window.IMPRO_BUNDLE = {
  ...
  "ui": {
    "fr": {
      ...
      "rulesClose": "Fermer",
      "settingsEditorHelp": "Édite directement les listes. Chaque section est un tableau JSON. exercices et catégories attendent {\"name\",\"desc\"} ; les autres sont des chaînes.",
      "language": "Langue",
      ...
      "supportNote": "Fonctionne en France, Belgique, Suisse, Luxembourg et au-delà — Stripe gère les cartes, Bancontact, SEPA, Apple/Google Pay, et la conversion de devise automatiquement.",
    ...
    "en": {
      ...
      "rulesClose": "Close",
      "settingsEditorHelp": "Edit the lists directly. Each section is a JSON array. exercises and categories expect {\"name\",\"desc\"}; the others are strings.",
      "language": "Language",
      ...
      "supportButton": "Send a tip",
      "supportSuggested": "Common amounts: €3 · €5 · €10 — or whatever feels right.",
      "supportNote": "Works in France, Belgium, Switzerland, Luxembourg and beyond — Stripe handles cards, Bancontact, SEPA, Apple/Google Pay, and currency conversion automatically.",
    ...
    "de": {
      ...
      "settingsEditorHelp": "Bearbeite die Listen direkt. Jeder Abschnitt ist ein JSON-Array. Übungen und Kategorien erwarten {\"name\",\"desc\"}; die anderen sind Zeichenketten.",
      "language": "Sprache",
      ...
      "supportButton": "Trinkgeld geben",
      "supportSuggested": "Übliche Beträge: 3 € · 5 € · 10 € — oder was sich richtig anfühlt.",
      "supportNote": "Funktioniert in Frankreich, Belgien, der Schweiz, Luxemburg und darüber hinaus — Stripe übernimmt Karten, Bancontact, SEPA, Apple/Google Pay und automatische Währungsumrechnung.",
    ...
    "es": {
      ...
      "rulesClose": "Cerrar",
      "settingsEditorHelp": "Edita las listas directamente. Cada sección es un array JSON. ejercicios y categorías esperan {\"name\",\"desc\"}; las demás son cadenas.",
      "language": "Idioma",
      ...
      "supportButton": "Dejar una propina",
      "supportSuggested": "Cantidades habituales: 3 € · 5 € · 10 € — o lo que te parezca justo.",
      "supportNote": "Funciona en Francia, Bélgica, Suiza, Luxemburgo y más allá — Stripe gestiona tarjetas, Bancontact, SEPA, Apple/Google Pay y la conversión de moneda automáticamente.",
    ...
    "pt": {
      ...
      "rulesClose": "Fechar",
      "settingsEditorHelp": "Edita as listas diretamente. Cada secção é um array JSON. exercícios e categorias esperam {\"name\",\"desc\"}; as outras são cadeias.",
      "language": "Idioma",
      ...
      "supportButton": "Deixar uma gorjeta",
      "supportSuggested": "Valores habituais: 3 € · 5 € · 10 € — ou o que te parecer justo.",
      "supportNote": "Funciona em Portugal, França, Bélgica, Suíça, Luxemburgo e mais — o Stripe trata dos cartões, Bancontact, SEPA, Apple/Google Pay e da conversão de moeda automaticamente.",
    ...
    "nl": {
      ...
      "rulesClose": "Sluiten",
      "settingsEditorHelp": "Bewerk de lijsten direct. Elke sectie is een JSON-array. oefeningen en categorieën verwachten {\"name\",\"desc\"}; de andere zijn strings.",
      "language": "Taal",
      ...
      "supportButton": "Een fooi geven",
      "supportSuggested": "Gangbare bedragen: € 3 · € 5 · € 10 — of wat juist voelt.",
      "supportNote": "Werkt in België, Frankrijk, Zwitserland, Luxemburg en daarbuiten — Stripe regelt kaarten, Bancontact, SEPA, Apple/Google Pay en automatische valutaconversie.",
